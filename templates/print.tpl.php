...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $print['language']; ?>" xml:lang="<?php print $print['language']; ?>">
  ...
  <body style="font-size:13px; margin-bottom: 0px;">
    ...
    <!--<hr class="print-hr" /> -->
    <div class="print-content style='margin-bottom: 10px;'"><?php print $print['content']; ?></div>

    <div class="print-foot" style = "width:100%">
      <hr class="" />
