...
<?php if ($time): ?>
  <?php if (!empty($topic_link)): ?>
    <?php if (isset($date_posted)): ?>
      <?php print t(
        '!title<br /><i class="icon-user"></i> !author<br />@date_posted', array(
        '!title' => $topic_link,
    ...
    <?php else: ?>
     <?php print t(
        '!title<br /><i class="icon-user"></i> !author<br /><i class="icon-calendar2"></i> @time før', array(
        '!title' => $topic_link,
        '@time' => $time,
        '!author' => $author,
      )); ?>
  ...
  <?php else: ?>
    <?php if (isset($date_posted)): ?>
      <?php print t(
        '<i class="icon-user"></i> !author<br />@date_posted', array(
        '@date_posted' => $date_posted,
        '!author' => $author,
      )); ?>
    <?php else: ?>
     <?php print t(
        '<i class="icon-user"></i> !author<br />@time ago', array(
        '@time' => $time,
        '!author' => $author,
      )); ?>
    <?php endif; ?>
